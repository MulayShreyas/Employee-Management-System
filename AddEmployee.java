...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfname, tffname, tlname, tfaddress, tfphone, tfaadhar, tfemail, tfsalary, tfdesignation;
    JDateChooser dcdob;
    ...
    AddEmployee() {
        ...
        labellastname.setBounds(50, 200, 150, 30);
        labellastname.setFont(new Font("serif", Font.PLAIN, 20));
        add(labellastname);

        tlname = new JTextField();
        tlname.setBounds(200, 200, 150, 30);
        add(tlname);
        ...
        tfsalary.setDocument(new NumericDocument());
        add(tfsalary);
        ...
        tfphone.setDocument(new NumericDocument());
        add(tfphone);
        ...
        tfaadhar.setDocument(new NumericDocument());
        add(tfaadhar);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                ...
                String query = "INSERT INTO Employee (firstname, fathername, lastname, dob, salary, address, phone, email, education, designation, aadhar, empId) VALUES ('" + firstname + "', '" + fathername + "', '" + lastname + "', '" + dob + "', '" + salary + "', '" + address + "', '" + phone + "', '" + email + "', '" + education + "', '" + designation + "', '" + aadhar + "', '" + empId + "')";
