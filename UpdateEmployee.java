...
public class UpdateEmployee extends JFrame implements ActionListener{
    JTextField tfeducation, tffname, tlname, tfaddress, tfphone, tfemail, tfsalary, tfdesignation;
    JLabel lblempId;
    JButton add, back;
    String empId;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                ...
                String query = "update Employee set fathername = '"+fathername+"',lastname = '"+lastname+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email =  '"+email+"', education = '"+education+"', designation = '"+designation+"' where empId = '"+empId+"'";
